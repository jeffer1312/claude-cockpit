...
def test_cwd_slug_keeps_spaces_accents_and_underscores():
    ...
    assert (pi_sessions.cwd_slug("/home/jefferson/Área de trabalho/promedico/pserver_servicos")
            == "--home-jefferson-Área de trabalho-promedico-pserver_servicos--")
...
def test_is_subagent_transcript_separates_the_task_runs_from_the_conversation():
    # Caminhos REAIS medidos na sessao promedico-web (2026-07-30): o subagente grava dentro de um
