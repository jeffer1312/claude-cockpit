...
JANELAS_KITTY1 = [
    {"pid": 63482, "class": "kitty", "title": "pserver_servicos", "address": "0xAAA"},
    {"pid": 63482, "class": "kitty", "title": "promedico-web", "address": "0xBBB"},
...
CLIENTES = {"claude-cockpit-2": [2324949], "jefferson": [615602],
            "promedico-web": [2562331], "pserver_servicos": [2606971]}

TITULOS = {"claude-cockpit-2": "claude-cockpit", "jefferson": "jefferson",
           "promedico-web": "promedico-web", "pserver_servicos": "pserver_servicos"}
...
def main() -> int:
    ...
    esperado = {"pserver_servicos": "0xAAA", "promedico-web": "0xBBB",
